        ...
        <div class="panel-heading">
            <h1 class="panel-title">
                @if(isset($dataTypeContent->id))
                    {{ 'Edit '.str_replace(":", ucfirst(getCurrentPharmacy()->name), $dataType->display_name_singular)  }}
                @else
                    {{ 'Add '.str_replace(":", ucfirst(getCurrentPharmacy()->name), $dataType->display_name_singular) }}
                @endif
            </h1>
        </div>
